                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form class="row g-3" action="{{ route('events.update', $event->id) }}" method="POST">
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating">
                                        <input type="date" class="form-control @error('lock_date') is-invalid @enderror" id="floatingLockDate" placeholder="Lock Date"
                                            name="lock_date" value="{{ old('lock_date', $event->lock_date) }}">
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating">
                                        <input type="date" class="form-control @error('start') is-invalid @enderror" id="floatingStart" placeholder="Start Date"
                                            name="start" value="{{ date('Y-m-d', strtotime($event->start)) }}">
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating">
                                        <input type="date" class="form-control @error('end') is-invalid @enderror" id="floatingEnd" placeholder="End Date"
                                            name="end"  value="{{ date('Y-m-d', strtotime($event->end)) }}">
                                ...
                                {{-- <div class="col-12">
                                    <div class="form-floating">
                                        <textarea class="form-control @error('description') is-invalid @enderror" placeholder="Description" id="floatingTextarea" style="height: 100px;" name="description">{{ old('description', $event->description) }}</textarea>
